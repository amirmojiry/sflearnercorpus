    ...
    <div class="container-fluid">
        ...
        if(count($_GET)>0) {
            ...
            if (mysqli_num_rows($text_query) > 0) {
                ...
                if ($text["LabeledText"]!=''){ $LabeledText = $text["LabeledText"];}
			...
			<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="card">
						...
						<div class="body">
							<form method="post" action="insertLabeling1text.php">
								...
								<div class="row clearfix">
									...
									<div class="col-sm-12">
										...
										<div id="LabeledDiv" name="LabeledDiv" class="collapse">
											<textarea id="LabeledText" name="LabeledText" class="form-control no-resize" required rows="8" onkeyup="editTextarea()" onmousedown="editTextarea()"></textarea>
